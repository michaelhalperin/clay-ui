  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        mint:     { 100: '#d1fae5', 200: '#a7f3d0', 400: '#34d399', 500: '#10b981' },
        peach:    { 100: '#fce7f3', 200: '#fbcfe8', 400: '#f472b6' },
        lemon:    { 100: '#fef9c3', 200: '#fef08a', 400: '#facc15' },
        lavender: { 100: '#ede9fe', 200: '#ddd6fe', 400: '#a78bfa', 500: '#8b5cf6' },
      },
      boxShadow: {
